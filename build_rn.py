...
jm_google_json_path = './google-services-jm.json'
...
new_icon_url = './assets/app_icons/icon_jn.png'  # Replace with your new icon URL
new_app_name = 'Antz Systems'
new_slug = 'antz-systems'
new_scheme = 'antzsystems'
new_version = '2.1.0'  # Replace with your new app version
new_adaptive_icon_foreground = './assets/app_icons/adaptive_icon.png'  # Replace with your new adaptiveIcon foreground image path
new_adaptive_icon_background_color = '#52F990'  # Replace with your new adaptiveIcon background color


with open(jm_google_json_path, 'r') as jm_json_file:
    jm_data = json.load(jm_json_file)

# Write the contents of the jm JSON file to the original JSON file
with open(default_google_json_path, 'w') as original_json_file:
    json.dump(jm_data, original_json_file, indent=2)

# Update the properties in app_data
app_data['expo']['icon'] = new_icon_url
app_data['expo']['name'] = new_app_name
# app_data['expo']['slug'] = new_slug
# app_data['expo']['scheme'] = new_scheme
app_data['expo']['version'] = new_version
app_data['expo']['client'] = 'ril'
app_data['expo']['ios']['bundleIdentifier'] = 'com.ril.antz'
app_data['expo']['android']['package'] = 'com.ril.antz'
...
variables_to_update = {
    'isDev': False,
    'vantara_build': True,
    'experience_id' : "@nidhintrell/antz-app",
    'uat_build': False,
}
