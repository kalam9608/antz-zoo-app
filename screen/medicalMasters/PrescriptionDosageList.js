...
import {
  medicalCaseType,
  prescriptiondosageList,
} from "../../services/MedicalMastersService";
import Spacing from "../../configs/Spacing";
import { useToast } from "../../configs/ToastConfig";

const PrescriptionDosagesList = () => {
  ...
  return (
    <>
      ...
      <Header noIcon={true} title={"Prescription Dosages"} />
      <View
        style={[
      ...
      >
        <View style={reduxColors.listSection}>
          <FlatList
            ...
            renderItem={(item) => (
              <ListComponent
                item={item}
                onPress={() =>
                  navigation.navigate("editprescriptiondosage", { site: item })
                }
              >
          ...
          <FloatingButton
            ...
            onPress={() => navigation.navigate("addprescriptiondosage")}
          />
        </View>
      </View>
    </>
...
const styles = (reduxColors) =>
  StyleSheet.create({
    container: {
      flex: 1,
      backgroundColor: reduxColors.onPirmary,
...
export default PrescriptionDosagesList;
