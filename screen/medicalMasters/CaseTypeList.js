...
import { medicalCaseType } from "../../services/MedicalMastersService";
...
const CaseTypeList = () => {
  ...
  const InnerComponent = ({ item }) => {
    ...
    return (
      <View>
        ...
        <View style={{ flexDirection: "row" }}>
          <Text>Status : </Text>
          <Text>{ifEmptyValue(capitalize(string_id))}</Text>
        </View>
      </View>
    );
  };
  ...
  return (
    <>
      ...
      <Header noIcon={true} title={"Case Types"} />
      <View
        style={[
      ...
      >
        <View style={reduxColors.listSection}>
          <FlatList
            ...
            renderItem={(item) => (
              <ListComponent
                item={item}
                onPress={() =>
                  navigation.navigate("editmedicalcasetype", { site: item })
                }
              >
          ...
          <FloatingButton
            ...
            onPress={() => navigation.navigate("addmedicalcasetype")}
          />
        </View>
      </View>
    </>
