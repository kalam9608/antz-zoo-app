...
import { editMedicalCaseType } from "../../services/MedicalMastersService";
...
const EditMedicalCaseType = (props) => {
  ...
  const [isSwitchOn, setIsSwitchOn] = React.useState(
    props.route.params?.site?.item?.active ?? false
  );
...
export default EditMedicalCaseType;
