...
import { medicalAdviceList } from "../../services/MedicalMastersService";
import Spacing from "../../configs/Spacing";
import { useToast } from "../../configs/ToastConfig";

const MedicalAdvicesList = () => {
  ...
  const InnerComponent = ({ item }) => {
    const { id, label, string_id, description, active } = item.item;
    return (
      <View>
  ...
  return (
    <>
      ...
      <Header noIcon={true} title={"Advices"} />
      <View
        style={[
      ...
      >
        <View style={reduxColors.listSection}>
          <FlatList
            ...
            renderItem={(item) => (
              <ListComponent
                item={item}
                onPress={() =>
                  navigation.navigate("editadvice", { site: item })
                }
              >
          ...
          <FloatingButton
            ...
            onPress={() => navigation.navigate("addadvice")}
          />
        </View>
      </View>
    </>
...
export default MedicalAdvicesList;
