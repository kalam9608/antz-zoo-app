...
new_icon_url = './assets/app_icons/icon_dev.png'  # Replace with your new icon URL
new_app_name = 'Antz Dev'  # Replace with your new app name
new_version = '1.7.3'  # Replace with your new app version
new_adaptive_icon_foreground = './assets/app_icons/adaptive_icon_dev.png'  # Replace with your new adaptiveIcon foreground image path
new_adaptive_icon_background_color = '#1F415B'  # Replace with your new adaptiveIcon background color
...
app_data['expo']['ios']['bundleIdentifier'] = 'com.antz'
app_data['expo']['android']['package'] = 'com.antz'
