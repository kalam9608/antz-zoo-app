...
staging_google_json_path = './google-services-dev.json'
...
new_icon_url = './assets/app_icons/icon_uat.png'  # Replace with your new icon URL
new_app_name = 'Antz Uat'  # Replace with your new app name
new_version = '1.7.3'  # Replace with your new app version
new_adaptive_icon_foreground = './assets/app_icons/adaptive_icon_uat.png'  # Replace with your new adaptiveIcon foreground image path
new_adaptive_icon_background_color = '#FFF2FF'  # Replace with your new adaptiveIcon background color
...
app_data['expo']['ios']['bundleIdentifier'] = 'com.antz.uat'
app_data['expo']['android']['package'] = 'com.antz.uat'
...
app_data['expo']['owner'] = "antzsystems"
...
variables_to_update = {
    'isDev': False,
    'experience_id' : "@antzsystems/antz-app",
    'vantara_build': False,
    'uat_build': True,
}
...
for variable_name, new_value in variables_to_update.items():
    pattern = re.compile(rf'const {re.escape(variable_name)}\s*=\s*(true|false|"@antz/antz-app"|"@antzsystems/antz-app");')
